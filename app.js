...
function bindLoginEvents() {
  ...
  app.querySelector("#adminLoginForm")?.addEventListener("submit", (event) => {
    ...
    if (email !== state.adminProfile.email.toLowerCase() || password !== state.adminProfile.password) {
